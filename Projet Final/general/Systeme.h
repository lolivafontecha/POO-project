...
class Systeme : public Dessinable {
    ...
    void evolue(double temps); /*/ fonction qui fait evouler tout les oscillateurs
                                du systemes d'un temps passé comme paramètre /*/

    virtual void dessine() override; // méthode héritée de Dessinable
    ...
    ~Systeme() {
        /*/La destruction d'un systeme comporte la destruction de ses
          oscillateurs. En effet, la façon dont laquelle on a conçu notre programme
          implique que chaque système a ses propres oscillateurs et c'est donc leur responsabilité
          de les détruire. Par contre, l'intégrateur d'un système pourrait être parfaitement partagé
          avec un autre système et, par conséquent, ce n'est pas au système de le detruire/*/
