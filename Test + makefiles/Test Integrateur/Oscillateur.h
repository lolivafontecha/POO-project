...
class Oscillateur
{
    ...
    Vecteur Origine;
     ...
     public:
    // Constructeurs
    Oscillateur(size_t n): Parametres(n),
        Vitesse(n), masse(0.0), Direction({1,0,0}), Origine({0,0,0}) {}
    /*/ 1. initialise les vecteurs de taille n a 0, la direction à (1, 0, 0) (c'est nous
    qui nous avons choisit cette convention), la masse a 0 et l'origine a (0,0,0) /*/
    ...
    /*/ 2. On passe un parametre pour chaque attribut et on fait unitaire le vecteur
    ...
    Vecteur eq_mvt() const; // equation du mouvement de l'oscillateur
